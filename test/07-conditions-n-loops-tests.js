...
describe('08-conditions-n-loops-tasks', () => {
  ...
  it.optional('isCreditCardNumber should validate CCN', () => {
    [
      79927398713, 4012888888881881, 5123456789012346, 378282246310005,
      371449635398431, 378734493671000, 5610591081018250, 30569309025904,
    ...
    [
      4571234567890111, 5436468789016589, 4916123456789012, 371449635398430,
      9112893456789010,
    ].forEach((ccn) => {
      assert(
  ...
  it.optional(
    'getCommonDirectoryPath should return a common path in the file system',
    () => {
      [
        {
